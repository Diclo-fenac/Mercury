...
class RedisService(ServiceInterface):
    ...
    async def cache_image_analysis(
        ...
        return await self.set_json(cache_key, analysis, ttl)
    
    async def get_image_analysis(self, image_id: str) -> Optional[Dict[str, Any]]:
